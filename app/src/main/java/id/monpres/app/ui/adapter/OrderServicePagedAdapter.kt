...
class OrderServicePagedAdapter(
    private val onItemClick: (OrderService, View) -> Unit // Regular click
) : PagingDataAdapter<OrderService, OrderServicePagedAdapter.ViewHolder>(OrderServiceDiffCallback()) {
    ...
    inner class ViewHolder(val binding: ItemTwoLineBinding) :
        ...
        fun bind(orderService: OrderService) {
            ...
            binding.root.transitionName =
                binding.root.context.getString(R.string.transition_name_item_paged, orderService.id)
