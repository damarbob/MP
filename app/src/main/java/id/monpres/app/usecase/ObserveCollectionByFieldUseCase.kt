...
class ObserveCollectionByFieldUseCase @Inject constructor(private val firestore: FirebaseFirestore) {
    companion object {
        val TAG = ObserveCollectionByFieldUseCase::class.simpleName
    }
    /**
     * Observes a Firestore collection for documents matching the given field and value.
     *
    ...
    operator fun <T : Any> invoke(
        ...
        awaitClose {
             Log.d(TAG, "Removing Firestore listener for $collection and $field: $value")
